...
INNER JOIN cidades ON cidades.id_cidade = cli.id_cidade
...
-- Selecione todos os produtos onde o preco seja maior que 500
SELECT * FROM produtos WHERE preco > 500;

-- Selecione a cidade correspondente do cliente
SELECT cli.nome,
cidades.nome_cidade
FROM clientes AS cli
INNER JOIN cidades ON cidades.id_cidade = cli.id_cidade;
...
-- Mostrar os produtos dos fornecedores
SELECT forn.nome_fornecedor,
produtos.nome_produto
FROM fornecedores AS forn
INNER JOIN produtos ON produtos.id_fornecedor = forn.id_fornecedor;


-- Voce precisa identificar o produto,
...
func.nome_funcionario AS NomeFuncionario,
cli.nome AS NomeCliente
FROM pedidos ped
INNER JOIN funcionarios func ON func.id_funcionario = ped.id_funcionario
